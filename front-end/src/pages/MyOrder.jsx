                                ...
                                <>
                                    <div className='bg-white rounded mt-6'>
                                        ...
                                        <div className='mx-5 py-5 flex items-center justify-end'>
                                            <Link to={`/my-order/${order._id}`} className='bg-transparent text-center borderItem hover:bg-orange-500 hover:text-white borderItem-orange-600 outline-none rounded-md p-3 w-[135px] transition-all duration-300'>
                                                Xem chi tiết
                                            </Link>
                                        </div>
                                    </div>                                           

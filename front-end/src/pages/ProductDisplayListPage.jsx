...
const ProductDisplayListPage = () => {
  ...
  let productId = params?.id?.split('-').slice(-1)[0]
  ...
  return (
    <section>
      <div className='container mx-auto p-4 grid lg:grid-cols-2'>
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
...

          {
            ...
            <>
              <p className='font-semibold mt-5'>Số lượng:</p>
              <div className='my-4'>
                <AddToCartInDetailPageButton data={productData} />
              </div>
            </>
            
          )}

          <h2 className='font-semibold'>Tại sao nên mua hàng của chúng tôi? </h2>
          <div>
      ...
      <div className='container mx-auto mt-8 w-full'>
        ...
        {/** Nội dung */}
        <div className='my-6 lg:grid gap-3 '>
        {
          activeTab === 'tab1' && 
          <div>

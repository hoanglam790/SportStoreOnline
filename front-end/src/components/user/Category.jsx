...
const Category = () => {
    ...
    return (
        <section>
            ...
            <div className='container mx-auto bg-white px-4 py-6 grid grid-cols-4 md:grid-cols-4 lg:grid-cols-6 gap-5 mt-14 rounded-lg'>
                {
                    loadingCategory ? (
                        ...
                        categoryData.map((cate,index) => {
                            return(
                                ...
                                className="flex flex-col items-center justify-center px-5 py-4 border rounded cursor-pointer transition-all">

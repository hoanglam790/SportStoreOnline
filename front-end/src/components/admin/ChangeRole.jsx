...
const ChangeRole = ({close, fetchUserData, data: userData}) => {
    ...
    return (
        <div className='fixed top-10 bottom-0 left-0 right-0 w-full h-full flex items-center justify-between bg-slate-200 bg-opacity-60'>
            <div className='mx-auto bg-white shadow-sm p-4 w-full max-w-sm rounded-lg'>
                ...
                <form onSubmit={updateUserRole}>
                    <h1 className='text-lg font-medium pb-4'>Chỉnh sửa:</h1>
                    <div className='my-2'>
                        <p>Email:</p>
                        <input
                            type='email'
